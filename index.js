...
app.get('/g2_test', authMiddleware, driverAuthorizationMiddleware, g2TestController);

app.post('/g2_test', authMiddleware, driverAuthorizationMiddleware, storeG2TestController);

app.get('/g_test', authMiddleware, driverAuthorizationMiddleware, gTestController);

app.post('/update_g_test', authMiddleware, driverAuthorizationMiddleware, updateGTestController);

app.get('/appointment', authMiddleware, adminAuthorizationMiddleware, appointmentController);
...
app.get('/result', authMiddleware, adminAuthorizationMiddleware, resultController);

app.get('/examiner', authMiddleware, examinerAuthorizationMiddleware, examinerController);

app.post('/examiner', authMiddleware, examinerAuthorizationMiddleware, examinerFeedbackController);
